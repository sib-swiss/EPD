...
function createMotifs(index)
{
	...
	eval(ajax[index].response);	// Executing the response from Ajax as Javascript code
        ...
        switch (motif_name) {
          case 'MA0007.2 AR':
            document.getElementById('si_name').value = 'MA0007.2 AR';
            document.getElementById('ref_pos').value = '  8';
            document.getElementById('co_per').checked = true;
            document.getElementById('co').value = ' 98.63';
          break;
          case 'TATA-box':
            document.getElementById('si_name').value = 'TATA-box';
            document.getElementById('ref_pos').value = '  4';
            document.getElementById('co_abs').checked = true;
            document.getElementById('co').value = ' -8.16';
          break;
          case 'Ar_nuclearreceptor_DBD dimeric':
            document.getElementById('si_name').value = 'Ar_nuclearreceptor_DBD dimeric';
            document.getElementById('ref_pos').value = '  9';
            document.getElementById('co_per').checked = true;
            document.getElementById('co').value = ' 97.77';
          break;
          case 'UP00108_1 Alx3_3418.2':
            document.getElementById('si_name').value = 'UP00108_1 Alx3_3418.2';
            document.getElementById('ref_pos').value = '  9';
            document.getElementById('co_per').checked = true;
            document.getElementById('co').value = ' 89.34';
          break;
        }
}
