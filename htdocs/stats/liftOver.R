data <- read.table("wwwtmp/liftOverStats", as.is=T)
...
png("wwwtmp/liftOver.png")
plot(data[,2]~data[,1], type="b", pch=19, xlab="Date", ylab="Monthly use", frame.plot="F", main="LiftOver")
