...
<!-- RIGHT TABLE -->
        <table class="epd-db3">
            ...
            <td>
                ...
                <a href="/cgi-bin/miniepd/get_doc?db=scEpdNew&format=genome&entry=PRO1_1">PRO1</a> and
                <a href="/cgi-bin/miniepd/get_doc?db=scEpdNew&format=genome&entry=CFT1_1">CFT1</a>.
                </div>
            </td>
        </tr>
    </table>
