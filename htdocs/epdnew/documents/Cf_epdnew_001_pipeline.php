...
<H1>TSS assembly pipeline for Cf_EPDnew_001</H1>
<P>
<h2>Introduction</h2>
...
<table class='document'>
  ...
  <tr>
    ...
    <td class='document' width='40'>
      <a target='_blank' href='<?php echo $url_ftp; ?>/mga/canFam3/ensembl/ensembl.html'>
      DOC</a>
    </td>
    <td class='document' width='40'>
      <a href='<?php echo $url_ftp; ?>/mga/canFam3/ensembl/Cf_ensembl92_tss_canFam3.sga.gz'>
      DATA</a>
    </td>
  </tr>
</table>
...
<table  class='document'>
  ...
  <tr>
    ...
    <td class='document'>
      <a target='_blank' href='https://www.ncbi.nlm.nih.gov/pubmed/29182598'>
      29182598</a>
    </td>
    <td class='document' width='40'>
      <a target='_blank'
    ...
    <td class='document' width='40'>
      <a target='_blank'
      href='<?php echo $url_ccg; ?>/mga/canFam3/lizio17/lizio17.html'>
      DOC</a>
    </td>
    <td class='document' width='40'>
      <a target='_blank'
      href='<?php echo $url_ftp; ?>/mga/canFam3/lizio17/'>
      DATA</a>
    </td>
  </tr>
...
ID. As a consequence, of the 24860 transcripts originally present in
the database, 23855 uniquely mapped promoters were kept in
the input list, covering 19971 genes.

<h3>2. UCSC TSS collection</h3>

If present, the UCSC TSS collection is stored as a tab-deliminated text file
conforming to the SGA format under the name (for dog):

<ul>
<i>Cf_ensembl92_tss_canFam3.sga</i>
</ul>
...
format using in-house software. There are a total number of 12 samples
in this collection. Individual SGA files can be downloaded from our
ftp website (link above).
