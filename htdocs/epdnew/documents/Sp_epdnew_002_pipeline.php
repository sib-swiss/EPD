...
<H1>TSS assembly pipeline for Sp_EPDnew_002</H1>
<P>
<h2>Introduction</h2>
...
<table  class='document'>
  ...
  <tr>
    ...
    <td class='document'>
      <a href='https://doi.org/10.1101/281642'>
	doi:281642
      </a>
    </td>
    <td class='document' width='40'>
      <a target='_blank'
      href='https://www.ncbi.nlm.nih.gov/sra?term=SRP133255'>SOURCE</a>
    </td>
    <td class='document' width='40'>
      <a target='_blank'
      href='<?php echo $url_ftp; ?>/mga/spo2/thodberg18/thodberg18.html'>
      DOC</a>
    </td>
    <td class='document' width='40'>
      <a target='_blank'
      href='<?php echo $url_ftp; ?>/mga/spo2/thodberg18/'>
      DATA</a>
    </td>
  </tr>
</table>
...
NCBI RefSeq</a> database, the 02-02-2015</ol>.
    ...
    Transcripts have been filtered for protein coding gene only, removing pseudogenes from the list.<br>
...
The RefSeq TSS collection is stored as a tab-delimited text file
