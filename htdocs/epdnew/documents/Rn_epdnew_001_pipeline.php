...
<H1>TSS assembly pipeline for Rn_EPDnew_001</H1>
<P>
<h2>Introduction</h2>
...
<table class='document'>
  ...
  <tr>
    ...
    <td class='document' width='40'>
      <a target='_blank' href='<?php echo $url_ftp; ?>/mga/rn6/ensembl/ensembl.html'>
      DOC</a>
    </td>
    <td class='document' width='40'>
      <a href='<?php echo $url_ftp; ?>/mga/rn6/ensembl/Rn_ensembl92_tss_rn6.sga.gz'>
      DATA</a>
    </td>
  </tr>
</table>
...
<table  class='document'>
  ...
  <tr>
    ...
    <td class='document' width='40'>
      <a target='_blank'
      href='<?php echo $url_ccg; ?>/mga/rn6/lizio17/lizio17.html'>
      DOC</a>
    </td>
    <td class='document' width='40'>
      <a target='_blank'
      href='<?php echo $url_ftp; ?>/mga/rn6/lizio17/'>
      DATA</a>
    </td>
  </tr>
...
ID. As a conseguence, from the 30190 transcripts originally present
in the database, 28847 uniquely mapped promoters remained in the input list,
covering 21919 genes.
...
format using in-house software. There are a total number of 13 samples
...
For each individual sample (13), peak calling for the merged file has been
carried out using <a
