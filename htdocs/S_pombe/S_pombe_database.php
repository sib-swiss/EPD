...
<!-- RIGHT TABLE -->
        <table class="epd-db3">
            ...
            <td>
                ...
                <a href="/cgi-bin/miniepd/get_doc?db=spEpdNew&format=genome&entry=SPAC227.05_1">SPAC227.05</a> and
                <a href="/cgi-bin/miniepd/get_doc?db=spEpdNew&format=genome&entry=SPAC227.06_1">SPAC227.06</a>.
                </div>
        </td>
        </tr>
    </table>
